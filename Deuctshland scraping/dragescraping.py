...
# address_parts listesinin uzunluğunu kontrol ederek ikinci elemanı alıyoruz veya None atıyoruz
    posta_sehir = address_parts[1] if len(address_parts) > 1 else None
